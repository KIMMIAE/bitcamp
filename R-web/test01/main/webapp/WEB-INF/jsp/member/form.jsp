...
<!-- 
<div class='form-group row'>
<label for='password' class='col-sm-2 col-form-label'>관심지역</label>
<div class="custom-control custom-checkbox">
  <input type="checkbox" id="areaNo1" name="areaNo" class="custom-control-input" value="1">
  <label class="custom-control-label" for="areaNo1">홍대</label>
</div>

<div class="custom-control custom-checkbox">
  <input type="checkbox" id="areaNo2" name="areaNo" class="custom-control-input" value="2">
  <label class="custom-control-label" for="areaNo2">대학로</label>
</div>

<div class="custom-control custom-checkbox">
  <input type="checkbox" id="areaNo3" name="areaNo" class="custom-control-input" value="3">
  <label class="custom-control-label" for="areaNo3">신촌</label>
</div>

<div class="custom-control custom-checkbox">
  <input type="checkbox" id="areaNo4" name="areaNo" class="custom-control-input" value="4">
  <label class="custom-control-label" for="areaNo4">건대</label>
</div>

<div class="custom-control custom-checkbox">
  <input type="checkbox" id="areaNo5" name="areaNo" class="custom-control-input" value="5">
  <label class="custom-control-label" for="areaNo5">한강공원</label>
</div>
</div>
