...
public class MemberController {
    ...
    public String list(
        ...
        Iterator<Member> iterator =memberService.list(pageNo, pageSize, options).iterator();
        while(iterator.hasNext()){
           System.out.println(iterator.next().getArtist());
        }
        return "member/list";
    }
    ...
    @RequestMapping("add")
    public String add(Member member, Artist artist/*, MultipartFile photo*/) throws Exception {
        /*
