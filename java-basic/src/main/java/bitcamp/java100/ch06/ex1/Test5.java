...
public class Test5 {
    public static void main(String[] args) {
        ...
        // 인스턴스를 만들 떄 생성자를 호출한다.
        //score = new Score4();    //컴파일 오류!  // Score4의 생성자는 파라미터 값을 받는 생성자이다.
        ...
        // score = new Score3; // 컴파일 오류! // 생성자를 반드시 호출해야 됨.
        
        // 생성자를 호출할 때 반드시 그 생성자가 원하는 파라미터 값을 넘겨야 한다.
        // score = new Score3("홍길동"); // 컴파일 오류! // 생성자가 필요없다는 값을 줘서 컴파일 오류! 
                                                      // Score3에는 문자열을 받는 생성자가 없다.
